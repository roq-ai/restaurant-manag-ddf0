  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to Restaurant Manager - Streamlining Your Processes for Exceptional Dining Experiences"
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to Restaurant Manager - Streamlining Your Processes for Exceptional Dining Experiences`}
            </Text>
            <Box
