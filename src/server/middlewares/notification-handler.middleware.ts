...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'order.create': {
    roles: ['business-owner', 'restaurant-manager', 'staff-member'],
  ...
  'reservation.update': {
    roles: ['business-owner', 'restaurant-manager', 'staff-member'],
    key: 'customer-reservation-update',
...
const tenantRoles: string[] = ['business-owner', 'restaurant-manager', 'staff-member'];
